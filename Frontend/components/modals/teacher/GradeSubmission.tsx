            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl w-full max-w-md shadow-2xl space-y-6">
                ...
                <form onSubmit={handleSubmitGrade} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={isLoading} className="px-6 py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-semibold hover:bg-emerald-500 transition cursor-pointer shadow-lg shadow-emerald-900/20 disabled:opacity-50 flex items-center justify-center min-w-[120px]">
